...
import cl.prodigio.sfa.api.scheduledpayment.dto.api.variablerecurringpayment.common.LimitsRequestDto;
...
@NoArgsConstructor
@AllArgsConstructor
public class VariableRecurringPaymentPnDto {
    ...
    @NotNull(message = "amountPolicy cannot be null")
    private AmountPolicyDto amountPolicy;
    @NotNull(message = "limits cannot be null")
    private LimitsRequestDto limits;
